...
let places:string[] = ["Pakistan","New York","USA","Germany","Dubai"];
console.log(places);
...
let places1:string[] = ["Pakistan","New York","USA","Germany","Dubai","Kashmir","London"]
console.log(places1);
console.log(places1.sort());
console.log(places1.reverse());
console.log(places1);
